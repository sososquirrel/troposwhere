...
def generate_simulation_paths(velocity: str, temperature: str, bowen_ratio: str, microphysic: str, folder_path:str='/burg/glab/users/sga2133/SAM_simulation_storage', ginsburg=False) -> dict:
    """
    ...
    if ginsburg:
        ...
        path_3d = os.path.join(folder_path, 'dataset_3d.nc')
        path_2d = os.path.join(folder_path, 'dataset_2d.nc')
        path_1d = os.path.join(folder_path, 'dataset_1d.nc')
